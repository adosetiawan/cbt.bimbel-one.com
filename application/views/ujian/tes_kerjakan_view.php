...
//console.log(timer)
    ...
    var clicksKecermatan = 0;
    function cermatJawab(jawaban){
        if(pilihanKecermatan.length>0){
            if(pilihanKecermatan.length > clicksKecermatan){
                ...
                if(jawaban == 1){
                    ...
                    pilihanKecermatan[clicksKecermatan].jawaban_saya = 'B';
                }else if(jawaban == 3){
                    pilihanKecermatan[clicksKecermatan].jawaban_saya = 'C';
                }else if(jawaban == 4){
                    pilihanKecermatan[clicksKecermatan].jawaban_saya = 'D';
                }else if(jawaban == 5){
    ...
    $(function () {
        ...
        $('#form-kerjakan').submit(function(){
            ...
            $.ajax({
                    ...
                    type:"POST",
                    data:$('#form-kerjakan').serialize()+ '&' + $.param(jawabanCermat),
                    cache: false,
                    timeout: 10000,
                    success:function(respon){
                        var obj = $.parseJSON(respon);
